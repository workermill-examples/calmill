...
test.describe('Public Booking Flow', () => {
  ...
  test.describe('Slot selection and booking form', () => {
    ...
    test('successfully submits booking form and redirects to confirmation', async ({ page }) => {
      await goToBookingPage(page);
      await waitForCalendarToLoad(page);
  ...
  test.describe('Booking confirmation page', () => {
    ...
    test('Google Calendar button generates a valid Google Calendar link', async ({ page }) => {
  ...
  test.describe('Cancel flow', () => {
    ...
    test('cancelled booking shows cancelled state on confirmation page', async ({ page }) => {
      // Cancel the booking
      await goToCancelPage(page, bookingUid);
      await submitCancellation(page);
      await assertBookingCancelled(page);
  ...
  test.describe('Reschedule flow', () => {
    ...
    test('reschedule page shows original booking time crossed out', async ({ page }) => {
      await goToReschedulePage(page, bookingUid);
  ...
  test.describe('Empty state handling', () => {
    test("shows 'no available times' message when date has no slots", async ({ page }) => {
      await goToBookingPage(page);
      await waitForCalendarToLoad(page);
  ...
  test.describe('Mobile responsive layout', () => {
    ...
    test('mobile booking page stacks calendar and slots vertically', async ({ page }) => {
      await goToBookingPage(page);
      await waitForCalendarToLoad(page);
