...
test.describe("Bookings", () => {
  ...
  test.describe("Authenticated Bookings", () => {
    authTest(
      "loads bookings page with correct content",
      async ({ authenticatedPage: page }) => {
        ...
        await expect(
          page.locator('button[role="tab"]:has-text("Upcoming")'),
        ).toBeVisible();
        await expect(
          page.locator('button[role="tab"]:has-text("Past")'),
        ).toBeVisible();
        await expect(
          page.locator('button[role="tab"]:has-text("Cancelled")'),
        ).toBeVisible();
        await expect(
          page.locator('button[role="tab"]:has-text("Pending")'),
        ).toBeVisible();
      },
    );

    authTest(
      "displays bookings tabs with counts",
      async ({ authenticatedPage: page }) => {
        await page.goto("/bookings");
        ...
        const upcomingTab = page.locator(
          'button[role="tab"]:has-text("Upcoming")',
        );
        const pastTab = page.locator('button[role="tab"]:has-text("Past")');
        const cancelledTab = page.locator(
          'button[role="tab"]:has-text("Cancelled")',
        );
        const pendingTab = page.locator(
          'button[role="tab"]:has-text("Pending")',
        );
    ...
    authTest(
      ...
      async ({ authenticatedPage: page }) => {
        ...
        await expect(
          page.locator(
            'button[role="tab"][aria-selected="true"]:has-text("Upcoming")',
          ),
        ).toBeVisible();
        ...
        const hasEmptyState = await page
          .locator('text="No upcoming bookings", text="No bookings found"')
          .isVisible();
        ...
        if (hasBookings) {
          ...
          await expect(
            firstBooking.locator("a[href*='/bookings/']"),
          ).toBeVisible(); // Title link
          await expect(
            firstBooking.locator('text="View Details"'),
          ).toBeVisible();
    ...
    authTest(
      "past tab shows historical bookings",
      async ({ authenticatedPage: page }) => {
        ...
        await expect(
          page.locator(
            'button[role="tab"][aria-selected="true"]:has-text("Past")',
          ),
        ).toBeVisible();
        ...
        const hasBookings = (await page.locator(".card").count()) > 0;
        const hasEmptyState = await page
          .locator('text="No bookings found", text="No past bookings"')
          .isVisible();
    ...
    authTest(
      ...
      async ({ authenticatedPage: page }) => {
        ...
        await expect(
          page.locator(
            'button[role="tab"][aria-selected="true"]:has-text("Cancelled")',
          ),
        ).toBeVisible();
        ...
        const hasBookings = (await page.locator(".card").count()) > 0;
        const hasEmptyState = await page
          .locator('text="No bookings found", text="No cancelled bookings"')
          .isVisible();
    ...
    authTest(
      ...
      async ({ authenticatedPage: page }) => {
        ...
        await expect(
          page.locator(
            'button[role="tab"][aria-selected="true"]:has-text("Pending")',
          ),
        ).toBeVisible();
        ...
        const hasBookings = (await page.locator(".card").count()) > 0;
        const hasEmptyState = await page
          .locator('text="No bookings found", text="No pending bookings"')
          .isVisible();
    ...
    authTest(
      "attendee email search filter works",
      async ({ authenticatedPage: page }) => {
        await page.goto("/bookings");
        await page.waitForTimeout(2000);
        ...
        const firstBooking = page.locator(".card").first();
        const emailText = await firstBooking
          .locator("text=/✉️.*@.*\..*/")
          .textContent();
        ...
        // Enter search query
        await page.fill(
          'input[placeholder="Search by attendee email..."]',
          email,
        );
        await page.waitForTimeout(1000);
    ...
    authTest("event type filter works", async ({ authenticatedPage: page }) => {
      ...
      const eventTypeSelect = page
        .locator("select")
        .filter({ hasText: /All event types|Filter by event type/ });
      ...
      if (await eventTypeSelect.isVisible()) {
        ...
        const options = await eventTypeSelect
          .locator("option")
          .allTextContents();

        // Pick the first non-"All" option
        const filterOption = options.find(
          (opt) => opt !== "All event types" && opt.trim() !== "",
        );
    ...
    authTest(
      ...
      async ({ authenticatedPage: page }) => {
        ...
        await expect(
          page.locator('input[placeholder="Search by attendee email..."]'),
        ).toHaveValue("");
        await expect(
          page.locator('input[type="date"][placeholder="Start date"]'),
        ).toHaveValue("");
    ...
    authTest(
      "pagination works when there are many bookings",
      async ({ authenticatedPage: page }) => {
        await page.goto("/bookings");
        await page.waitForTimeout(2000);
        ...
        const paginationInfo = page.locator(
          "text=/Showing \\d+ to \\d+ of \\d+ bookings/",
        );
    ...
    authTest(
      ...
      async ({ authenticatedPage: page }) => {
        ...
        // May show notes
        const hasNotes = await firstBooking
          .locator("text=/Notes:/", { hasText: /Notes:/ })
          .isVisible();
        // Notes are optional
      },
    );
  ...
  test.describe("Error Handling", () => {
    authTest(
      ...
      async ({ authenticatedPage: page }) => {
        ...
        await expect(
          page.locator('text="Error loading bookings"'),
        ).toBeVisible();
        await expect(
  ...
  test.describe("Responsive Design", () => {
    authTest(
      "bookings page is responsive on mobile",
      async ({ authenticatedPage: page }) => {
        // Set mobile viewport
    ...
    authTest(
      "bookings page is responsive on tablet",
      async ({ authenticatedPage: page }) => {
        // Set tablet viewport
  ...
  test.describe("Accessibility", () => {
    authTest(
      "bookings page has proper heading structure",
      async ({ authenticatedPage: page }) => {
        await page.goto("/bookings");
        await page.waitForTimeout(1000);
    ...
    authTest(
      "search and filter controls have proper labels",
      async ({ authenticatedPage: page }) => {
        await page.goto("/bookings");
        await page.waitForTimeout(1000);
        ...
        await expect(
          page.locator('input[placeholder="Start date"]'),
        ).toBeVisible();
        await expect(
          page.locator('input[placeholder="End date"]'),
        ).toBeVisible();
      },
    );

    authTest(
      "booking cards have proper structure",
      async ({ authenticatedPage: page }) => {
        await page.goto("/bookings");
        await page.waitForTimeout(2000);
