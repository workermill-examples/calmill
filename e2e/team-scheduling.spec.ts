...
test.describe('Team Scheduling', () => {
  ...
  test.describe('Teams page', () => {
    ...
    test('teams page shows heading', async ({ page }) => {
      ...
      await expect(page.locator('h1, h2', { hasText: /Teams/i }).first()).toBeVisible({
        timeout: 10_000,
      });
    });
    ...
    test('teams page shows Create Team button', async ({ page }) => {
      ...
      await expect(page.locator('button', { hasText: /Create Team/i })).toBeVisible({
        timeout: 10_000,
      });
    });

    test.fixme('teams page shows empty state or team list', async ({ page }) => {
      await page.goto('/teams');
  ...
  test.describe('Create team dialog', () => {
    ...
    test('create team dialog shows slug preview as name is typed', async ({ page }) => {
      await page.locator('button', { hasText: /Create Team/i }).click();
      await page.locator('[role="dialog"]').waitFor({ state: 'visible', timeout: 5_000 });
    ...
    test('pressing Escape dismisses the create team dialog', async ({ page }) => {
      await page.locator('button', { hasText: /Create Team/i }).click();
      await expect(page.locator('[role="dialog"]')).toBeVisible({
        timeout: 5_000,
      });
    ...
    test('clicking backdrop dismisses the create team dialog', async ({ page }) => {
      await page.locator('button', { hasText: /Create Team/i }).click();
      await expect(page.locator('[role="dialog"]')).toBeVisible({
        timeout: 5_000,
      });
  ...
  test.describe('Team detail page', () => {
    ...
    test('team detail shows members tab', async ({ page }) => {
      ...
      await expect(page.locator('button', { hasText: /Members/i })).toBeVisible({
        timeout: 10_000,
      });
    });
    ...
    test('team detail shows event types tab', async ({ page }) => {
      ...
      await expect(page.locator('button', { hasText: /Event Types/i })).toBeVisible({
        timeout: 10_000,
      });
    });
    ...
    test('team detail shows settings tab', async ({ page }) => {
      ...
      await expect(page.locator('button', { hasText: /Settings/i })).toBeVisible({
        timeout: 10_000,
      });
    });
  });
  ...
  test.describe('Invite member', () => {
    ...
    test('team members tab shows Invite Member button for owner', async ({ page }) => {
      if (!teamSlug) {
        await page.goto('/teams');
        await expect(page.locator('h1, h2', { hasText: /Teams/i }).first()).toBeVisible();
        return;
  ...
  test.describe('Team event type creation', () => {
    ...
    test('event types tab shows New Team Event Type button for admins', async ({ page }) => {
      if (!teamSlug) {
        await page.goto('/teams');
        await expect(page.locator('h1, h2', { hasText: /Teams/i }).first()).toBeVisible();
        return;
    ...
    test('team event type dialog shows Round Robin scheduling option', async ({ page }) => {
      if (!teamSlug) {
        await page.goto('/teams');
        await expect(page.locator('h1, h2', { hasText: /Teams/i }).first()).toBeVisible();
        return;
    ...
    test('team event type dialog shows Collective scheduling option', async ({ page }) => {
      if (!teamSlug) {
        await page.goto('/teams');
        await expect(page.locator('h1, h2', { hasText: /Teams/i }).first()).toBeVisible();
        return;
  ...
  test.describe('Team public booking page', () => {
    test('team booking page renders a calendar for round-robin event types', async ({ page }) => {
