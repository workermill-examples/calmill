        ...
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              <HeaderToggle checked={isActive} onChange={handleToggle} loading={toggleLoading} />
              <a
                href={bookingUrl}
                target="_blank"
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        >
          {activeTab === 'availability' && (
            <AvailabilityTab eventType={eventType} onSave={debouncedSave} />
          )}
        </div>
        ...
        >
          {activeTab === 'limits' && <LimitsTab eventType={eventType} onSave={debouncedSave} />}
        </div>
        ...
        >
          {activeTab === 'booking' && <BookingTab eventType={eventType} onSave={debouncedSave} />}
        </div>
        ...
        >
          {activeTab === 'recurring' && (
            <RecurringTab eventType={eventType} onSave={debouncedSave} />
          )}
        </div>
      </div>
