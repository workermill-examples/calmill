        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-6 max-w-2xl mx-auto text-lg text-gray-600 sm:text-xl">
              The open-source scheduling platform with Google Calendar sync, team scheduling,
              embeddable widgets, and webhooks. Built to showcase what AI can create.
            </p>

            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/signup" className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-blue-700 shadow-sm h-10 rounded-md px-8 text-base text-lg px-8 py-3">
                Get Started Free
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <CardDescription>
                  Intelligent availability detection with Google Calendar sync. Automatically find the perfect time for everyone.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <CardDescription>
                  Round-robin and collective scheduling for teams. Manage multiple calendars and availability preferences seamlessly.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <CardDescription>
                  Lightweight embeddable widgets for your website. One line of code to add scheduling to any page.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              This entire application was built autonomously by AI coding agents. CalMill showcases
              the power of AI-driven development - from architecture to deployment, every line of code
              was written by artificial intelligence.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 text-sm">
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="font-semibold text-gray-900 mb-2">Full-Stack Development</div>
                <div className="text-gray-600">Next.js 16, TypeScript, Prisma, PostgreSQL</div>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="font-semibold text-gray-900 mb-2">Modern Architecture</div>
                <div className="text-gray-600">API routes, authentication, real-time sync</div>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="font-semibold text-gray-900 mb-2">Production Ready</div>
                <div className="text-gray-600">Tests, CI/CD, scalable infrastructure</div>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center md:text-right text-gray-400">
              <p className="text-sm">
                ...
                <a href="https://workermill.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 ml-1">
                  WorkerMill AI
                </a>
              </p>
