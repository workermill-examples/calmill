...
import { PublicBookingPage } from "./booking-page-client";
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <LoadingSkeleton className="w-full h-96 rounded-lg" />
          </div>
        </div>
      </div>
    </div>
...
async function BookingPageContent({ params, searchParams }: PageProps) {
  ...
  // If the event type is inactive, redirect to user profile
  if (!eventType) {
    redirect(`/${username}`);
  }
