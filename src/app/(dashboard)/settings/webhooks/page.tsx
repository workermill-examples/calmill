...
function CheckIcon({ className }: { className?: string }) {
  return (
    <svg className={cn("h-4 w-4", className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
      ...
      <div className="relative z-10 w-full max-w-lg rounded-xl bg-white p-6 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            />
            <p className="mt-1 text-xs text-gray-500">Must use HTTPS (localhost allowed for development).</p>
          </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-lg rounded-xl bg-white p-6 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label htmlFor="edit-webhook-url" className="block text-sm font-medium text-gray-700 mb-1.5">
              Endpoint URL
            </label>
            <input
              id="edit-webhook-url"
  ...
  return (
    <div className="overflow-x-auto">
      <table className="min-w-full divide-y divide-gray-200 text-sm">
        <thead>
          <tr>
            <th className="py-3 pr-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wide">Time</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wide">Event</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wide">Status</th>
            <th className="py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wide">Result</th>
          </tr>
        </thead>
            ...
            <tr key={d.id} className="hover:bg-gray-50">
              ...
              <td className="py-2.5">
                {d.success ? (
                  ...
                  <span className="flex items-center gap-1 text-red-600" title={d.error ?? undefined}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 space-y-5">
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div className="min-w-0">
            <p className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Endpoint URL</p>
        ...
        {/* Triggers */}
        <div>
          <p className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">Event Triggers</p>
      ...
      {showDeleteConfirm && (
        ...
        >
          <div className="absolute inset-0 bg-black/40" onClick={() => setShowDeleteConfirm(false)} aria-hidden="true" />
          <div className="relative z-10 w-full max-w-sm rounded-xl bg-white p-6 shadow-xl">
            <h3 id="delete-webhook-title" className="text-base font-semibold text-gray-900">Delete webhook?</h3>
            <p className="mt-2 text-sm text-gray-600">
              This will permanently delete the webhook and all its delivery history. This action cannot be undone.
            </p>
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-gray-200 bg-gray-50 p-6">
        ...
        <ul className="mt-3 space-y-2 text-sm text-gray-600">
          ...
          <li className="flex items-start gap-2">
            <CheckIcon className="h-4 w-4 text-primary-500 mt-0.5 shrink-0" />
            Verify the signature via the <code className="rounded bg-gray-200 px-1 py-0.5 font-mono text-xs">X-CalMill-Signature</code> header.
          </li>
        </ul>
      </div>
