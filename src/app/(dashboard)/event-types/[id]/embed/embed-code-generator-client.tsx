      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="mt-0.5 text-sm text-gray-500">
            Add <strong className="font-medium text-gray-700">{eventType.title}</strong> ({eventType.duration} min) to any website.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-6 space-y-5">
            ...
            {activeTab === "inline" && (
              <div>
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  />
                  <div>
                    <span className="block text-sm font-medium text-gray-700">Hide event details</span>
            ...
            {/* Timezone */}
            <div>
              <label htmlFor="embed-timezone" className="block text-sm font-medium text-gray-700 mb-1.5">
                Pre-set timezone
              </label>
              <select
                id="embed-timezone"
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-6">
            ...
            <p className="mt-3 text-xs text-gray-500">
              Paste this snippet anywhere in your HTML. The script tag can be included once per page.
            </p>
          </div>
        </div>
