...
function RoleBadge({ role }: { role: "OWNER" | "ADMIN" | "MEMBER" }) {
  ...
  return (
    <span className={cn("inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium", config[role])}>
      {label[role]}
    </span>
  );
}
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          {team.bio && (
            <p className="mt-1.5 text-sm text-gray-600 line-clamp-2">{team.bio}</p>
          )}
    ...
    <div className="rounded-lg border border-gray-200 bg-white p-12 text-center">
      <div className="mx-auto max-w-md">
        ...
        <p className="mt-2 text-sm text-gray-600">
          Create a team to schedule events with multiple people using round-robin or collective booking.
        </p>
        <div className="mt-6">
