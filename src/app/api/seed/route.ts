  ...
  try {
    ...
    const eventTypesData = [
      {
        title: 'Quick Chat',
        slug: 'quick-chat',
        description: 'A brief 15-minute conversation to discuss your needs and see how I can help.',
        duration: 15,
        isActive: true,
      ...
      },
      {
        ...
        description: 'A comprehensive 30-minute meeting to dive deeper into your project requirements.',
        duration: 30,
        isActive: true,
        requiresConfirmation: false,
        minimumNotice: 120,
        ...
        customQuestions: JSON.stringify([
          ...
          },
          {
            ...
            label: 'Meeting Type',
            required: true,
            options: ['Discovery Call', 'Technical Discussion', 'Project Planning', 'Other']
          }
        ])
      },
      {
        ...
        description: 'An in-depth consultation session to thoroughly analyze your requirements and provide detailed recommendations.',
        duration: 60,
        isActive: true,
      ...
      },
      {
        ...
        description: 'A 45-minute technical interview session for engineering positions.',
        duration: 45,
        isActive: true,
        requiresConfirmation: true,
        ...
        customQuestions: JSON.stringify([
          ...
          },
          {
            ...
            required: true,
            options: ['JavaScript', 'TypeScript', 'React', 'Node.js', 'Python', 'Go', 'Java', 'Other']
          }
        ])
      },
      {
        ...
        description: 'A collaborative 90-minute coding session where we work together on real problems.',
        duration: 90,
        isActive: true,
        requiresConfirmation: false,
        minimumNotice: 360,
        ...
        customQuestions: JSON.stringify([
          ...
          },
          {
            ...
            required: true,
            placeholder: 'Describe the problem or feature you would like to work on...'
          }
        ])
      },
      {
        title: 'Coffee Chat',
        slug: 'coffee-chat',
        description: 'A casual 20-minute coffee chat to get to know each other.',
        duration: 20,
    ...
    const bookingsData = [
      ...
      },
      {
        ...
        responses: JSON.stringify({
          project_details: 'Looking to rebuild our customer portal with modern technologies. Current system is 10+ years old and struggling with scale.',
      ...
      },
      {
        ...
        responses: JSON.stringify({
          language: 'TypeScript',
          problem_description: 'Building a real-time collaborative editor using WebSockets and operational transforms'
        })
      },
      {
      ...
      },
      {
        ...
        location: 'Google Meet',
        responses: JSON.stringify({
          project_details: 'Building a multi-tenant SaaS platform for the Indian market with specific compliance requirements.',
      ...
      // Pending bookings (3)
      {
        ...
        responses: JSON.stringify({
          project_details: 'Enterprise digital transformation initiative. Looking to modernize 15+ legacy applications across multiple departments.',
          budget_range: '$100k+',
          timeline: '6+ months'
        })
      },
      {
        ...
        responses: JSON.stringify({
          language: 'Python',
          problem_description: 'Optimizing neural network training pipeline for faster convergence and better accuracy'
        })
      },
      {
    ...
    for (const bookingData of bookingsData) {
      ...
      const endTime = new Date(bookingData.startTime.getTime() + bookingData.duration * 60 * 1000)
          ...
          customQuestions: JSON.stringify([
            {
              ...
              required: true,
              options: ['Product Overview', 'Technical Deep-dive', 'Integration Capabilities', 'Custom Requirements']
            },
            {
              id: 'attendee_count',
              type: 'select',
    ...
    const summary = {
      ...
      data: {
        ...
        counts: {
          ...
          availability: businessHoursAvailability.length + extendedHoursAvailability.length,
          dateOverrides: 2,
          teamMembers: 3
        }
      }
