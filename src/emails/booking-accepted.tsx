...
export interface BookingAcceptedEmailProps {
  ...
  /** Duration in minutes */
  duration: number;
  /** Formatted start time in attendee's timezone */
  startTime: string;
...
export function BookingAcceptedEmail({
  ...
  const preview = `Meeting confirmed: ${eventTypeTitle} with ${hostName}`;
  ...
  return (
    <EmailLayout preview={preview}>
      ...
      <Text style={styles.heading}>Meeting confirmed by host</Text>
      <Text style={styles.subheading}>
        Hi {attendeeName}, <strong>{hostName}</strong> has confirmed your meeting request.
        You&apos;re all set!
      </Text>
